...
function HeroSection() {
  return (
    <section className="hero-section">
      ...
      <br />
      <p>
      Explore our range of products and services designed to provide you with the best in security and illumination. Our dedicated team is committed to delivering excellence, ensuring that your experience with us is seamless and satisfying. Welcome to a brighter, safer future with Xliteviewglobal!
      </p>
     </section>
  )
}
